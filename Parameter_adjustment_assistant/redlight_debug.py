...
def red_light_detection(image_path):
    ...
    cv2.createTrackbar('Smooth Kernel', '2. Smooth Image', 5, 20, on_trackbar_change)
    cv2.createTrackbar('Gaussian Blur', '3. Gaussian Blurred Image', 15, 50, on_trackbar_change)
    ...
    cv2.createTrackbar('Min Area', '6. Contours and Red Light', 100, 5000, on_trackbar_change)
    cv2.createTrackbar('Max Area', '6. Contours and Red Light', 1000, 5000, on_trackbar_change)
    ...
    while True:
        ...
        for contour in contours:
            ...
            if min_area < area < max_area:
                ...
                if 0.75 <= aspect_ratio <= 1.25:  # 近似圆形
                    cv2.rectangle(image, (x, y), (x + w, y + h), (0, 255, 0), 2)
                    detected = True
        
        cv2.imshow('6. Contours and Red Light', image)
